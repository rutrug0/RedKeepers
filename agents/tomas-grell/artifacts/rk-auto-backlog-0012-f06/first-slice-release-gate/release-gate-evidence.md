...
Timestamp (UTC): 2026-02-27T15:56:54.851429Z
Overall Status: PASS
...
- `playable`: PASS (exit=0)
  ...
  - artifact_log: `agents/tomas-grell/artifacts/rk-auto-backlog-0012-f06/first-slice-release-gate/playable-gate.log`
- `quality`: PASS (exit=0)
  - summary: `Workload Buckets: ready=dependency-ready queued, waiting=queued with unmet dependencies.`
  - artifact_log: `agents/tomas-grell/artifacts/rk-auto-backlog-0012-f06/first-slice-release-gate/quality-gate.log`
- `platform`: PASS (exit=0)
  ...
  - artifact_log: `agents/tomas-grell/artifacts/rk-auto-backlog-0012-f06/first-slice-release-gate/platform-gate.log`
- `hostile_token_contract`: PASS (exit=0)
  ...
  - artifact_log: `agents/tomas-grell/artifacts/rk-auto-backlog-0012-f06/first-slice-release-gate/hostile-token-contract-gate.log`
