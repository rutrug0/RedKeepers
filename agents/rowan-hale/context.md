...
- Prioritize retention and player satisfaction: clear short-term goals, strong session pacing, and credible return hooks
...
Retention heuristics to apply in design outputs:
- Motivation loop: anticipation -> action -> feedback -> progress
- Session rhythm: reduce idle stretches; preserve meaningful decision cadence
- Friction control: distinguish "challenge" from "confusion" and remove confusion
- Satisfaction check: each core loop should create visible mastery or ownership gains
