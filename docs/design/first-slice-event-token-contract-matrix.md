...
| `event.scout.unavailable_tile` | `target_tile_label` |
...
| `scout` | `event.scout.unavailable_tile` | `canonical-default` | `event.scout.unavailable_tile` | `yes` | `event.world.scout_unavailable_tile` |
| `scout` | `event.world.scout_unavailable_tile` | `compatibility-only` | `event.scout.unavailable_tile` | `no` | `(n/a)` |
